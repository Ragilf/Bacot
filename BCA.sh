...
clear
echo  $red
echo 'Sabar LUCKNUT...####... Prosses Sedang Berjalan.. ###...';
sleep 3.0;
clear
echo  $red
echo 'Sabar Anjenk.............................';
...
clear
echo  $red
echo  'Udah Di Bilangin Sabar Anjenk...............';
sleep 2.0;
echo  $green
echo 'Processing 80%...';
sleep 1.0;
...
sleep 1.0;
echo  $green
echo 'Harap Sabar Kentod...Dikit Lagi...';
sleep 2.0;
echo  $red
echo "Loading..............91%.......................";
sleep 1.0;
...
echo
echo
toilet -f future "  BLACK DEFACER TOOLS " | lolcat
echo
echo $red"#####################$green" SELAMAT DATANG "$red######################"
echo $yellow
figlet -f future " BLACK CYBER ANONYMOUS "
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"Mister Black Cyber"$cyan" ~BlackCyberAnonim"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"Mister Black Cyber"$cyan" ~BlackCyberAnonim"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"Mister Black Cyber"$cyan" ~/Nama SC Kalian ya harus (index.html) "$white
read -p " ╰─$ "  script
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : Mister Fukuro	"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] Mister Black Cyber "
echo $cyan"[+] All Member M°A "
echo $cyan"[+] MR FUKURO "
echo $red"##########################$green" WELCOME "$red###########################"
